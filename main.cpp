...
//Precondition: s1, s2, s3, s4, aD, and sD are all non-zero, non-negative numbers.
//Postcondition: Displays the average and standard deviation of the four scores.

//void clearScreen(); //Clears the console screen.

double computeADeviation(int s1, int s2, int s3, int s4);
//Precondition: Variables s1, s2, s3, and s4 are all non-zero, non-negative numbers.
